...
const PROMPT = "Melhore esta foto de imóvel mantendo aparência de FOTOGRAFIA REAL, não renderização. Preserve 100% do ambiente, móveis, layout, texturas, cores das paredes, piso e todos os elementos da cena original. Ajustes permitidos: correção suave de exposição, balanço de branco neutro, remoção de leve desfoque, nitidez moderada e endireitamento sutil. PROIBIDO: HDR exagerado, saturação artificial, superfícies plásticas ou cerâmicas idealizadas, aparência de render 3D, cores irreais, iluminação de estúdio, contraste excessivo, efeito de catálogo/revista. Mantenha iluminação natural equilibrada, sombras suaves preservadas e um leve ruído fotográfico aceitável. Entregue no formato HORIZONTAL (paisagem 3:2). Se a foto original for vertical, faça outpainting fotorrealista estendendo naturalmente parede, piso, teto e iluminação para preencher as laterais — NUNCA deixe faixas brancas, cinzas ou bordas. A imagem inteira deve parecer UMA FOTO ÚNICA, real e coerente.";
